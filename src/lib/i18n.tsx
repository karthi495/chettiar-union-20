...
const dict = {
  en: {
    ...
    communityDirectoryTagline: "Connect with Chettiar families across Tamil Nadu for weddings, functions, business and community events.",
    registerFamily: "Register your family",
    searchPlaceholderCommunity: "Search by family name, city, district...",
    allFunctionTypes: "All Function Types",
    recentRegistrations: "Recent Community Registrations",
    dashboard: "Dashboard",
  ...
  ta: {
    ...
    browse: "உலாவு",
    sangams: "சங்கங்கள்",
    communityDirectory: "சமூக அடைவு",
    communityDirectoryTagline: "திருமணம், விழாக்கள், வணிகம் மற்றும் சமூக நிகழ்வுகளுக்காக தமிழ்நாடு முழுவதும் உள்ள செட்டியார் குடும்பங்களுடன் இணையுங்கள்.",
    registerFamily: "உங்கள் குடும்பத்தை பதிவு செய்க",
    searchPlaceholderCommunity: "குடும்பப் பெயர், நகரம், மாவட்டம் தேடுங்கள்...",
    allFunctionTypes: "அனைத்து விழா வகைகள்",
